...
const Banner = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 pt-24 pb-20 bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-hidden relative">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="overflow-hidden">
              <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed animate-slide-up animation-delay-300">
                Passionate Computer Science & Technology student specializing in
                modern web development. Building beautiful, functional web
            ...
            <div className="overflow-hidden">
              <div className="flex flex-wrap gap-3 animate-slide-up animation-delay-500">
                {[
                  ...
                  { name: "Node Js", color: "from-blue-400 to-cyan-500" },
                  { name: "Express Js", color: "from-blue-400 to-cyan-500" },
                  { name: "Mongodb", color: "from-blue-400 to-cyan-500" },
                  {
                    name: "JavaScript",
                  ...
                  { name: "Next Js", color: "from-purple-400 to-pink-500" },
                ].map((tech, index) => (
                  <span
                    key={tech.name}
                  ...
                  >
                    <div
                      className={`absolute inset-0 bg-gradient-to-r ${tech.color} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                    ></div>
            ...
            <div className="flex flex-wrap gap-6 pt-8 animate-fade-in-up animation-delay-700">
              <a
                href="#contact"
                className="group relative px-10 py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-1 active:translate-y-0 overflow-hidden"
              >
              ...
              {[
                {
                  name: "GitHub",
                  icon: <FaGithub />,
                  url: "https://github.com/sabbir-ahmedcse",
                },
                {
                  name: "LinkedIn",
                  icon: <FaLinkedin />,
                  url: "https://www.linkedin.com/in/sabbir-ahmedcse/",
                },
                {
                  name: "Facebook",
                  icon: <FaFacebook />,
                  url: "https://www.facebook.com/MdSabbirRumon2",
                },
                {
                  name: "Instagram",
                  icon: <FaInstagram />,
                  url: "https://www.instagram.com/sa_bb_ir_ah_me_d/?hl=en",
                },
              ].map((social) => (
                <a
                  key={social.name}
                ...
                >
                  ...
                  <div className="relative w-14 h-14 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-2xl group-hover:scale-110 transition-all duration-300">
                    <span className="text-3xl text-gray-800 dark:text-white group-hover:text-blue-500 transition-all duration-300">
                      {social.icon}
                    </span>
                  </div>
          ...
          <div className="relative flex justify-center items-center animate-fade-in-up animation-delay-500">
            <div className="relative max-w-sm w-full">
              ...
              <div className="relative bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 rounded-full p-1.5 shadow-2xl transform transition-transform duration-700 hover:scale-105 hover:rotate-2">
                <div className="relative bg-white dark:bg-gray-900 rounded-full overflow-hidden">
                  {/* Image with zoom hover and shine */}
                  <div className="relative group">
                    ...
                    <img
                      src={sabbir}
                      alt="Sabbir Ahmed"
                      className="w-80 h-80 md:w-96 md:h-96 object-cover object-center transition-transform duration-500 group-hover:scale-110"
                    />
